...
class ThreatAnalyzer:
    ...
    def extract_features(self, payload: str) -> Dict[str, Any]:
        """Extract 50+ features from payload for threat analysis"""
        ...
        for feature, weight in weights.items():
            if feature in features:
                ...
                if isinstance(value, bool):
                    ...
                    if feature == "sql_keywords_count":
                        score += min(value * 5, weight)
                    elif feature == "payload_length":
    ...
    def detect_anomaly_vs_baseline(self, features: Dict[str, Any]) -> float:
        ...
        try:
            ...
            anomaly_score = min(distance / 3, 100)
    ...
    def add_benign_baseline(self, payload: str):
        ...
        self.benign_baseline.append(baseline_point)